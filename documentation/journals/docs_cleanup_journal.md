...
| where | open |
|---|---|
| `elemental_system_journal.md` | the owner's sign-off on "one application per window" (time mode) |
...
| `pygbag.md` | W9 GitHub Pages deploy (the owner's call, no CI) and the optional bundle trim |
