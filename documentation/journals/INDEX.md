...
| TST-002 | Remove the exit-2 skip from the cut-script tests | TST, RND | bug | in progress | [cut_script_skips_journal.md](cut_script_skips_journal.md) | claude/optimistic-poincare-e34af9 | 2026-09-22 |
