...
*(DOC-005, 2026-09-24: **obsolete** — the offline composer (option C) was never built; the owner delivered two tracks instead, shipped in `music_tracks_journal.md`. The stereo 44.1 kHz device it asked about shipped there too)*
...
*(DOC-005, 2026-09-24: the second entry — **shipping the two delivered tracks**, 2026-09-16 — now lives in its own file, [`music_tracks_journal.md`](music_tracks_journal.md), as the owner decided.)*
